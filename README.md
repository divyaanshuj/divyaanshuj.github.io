...
- `styles.css` - layout, colors, responsive design, and dark mode
- `script.js` - mobile menu and dark mode toggle
- `.nojekyll` - tells GitHub Pages to serve the files exactly as written

## What I Need From You

Send any details you already have. Partial information is fine.
...
1. Create a new GitHub repository named `yourusername.github.io` for a user site, or any repository name for a project site.
2. Upload these files to the repository.
3. In GitHub, open `Settings` > `Pages`.
4. Set the source to `Deploy from a branch`.
5. Choose the `main` branch and `/root` folder.
6. Save. GitHub will provide the public website URL after the first deployment.

For a user site, the URL will usually be:
